...
class Table(
    ...
    def _sentinel_column_characteristics(
        ...
        includes all the details.html needed by :class:`.Dialect` and
        ...
        :param autoincrement: Set up "auto increment" semantics for an
          ...
          * DDL issued for the column, if the column does not already include
            ...
            * Third-party dialects - consult those dialects' documentation
              for details.html on their specific behaviors.
    ...
    def __init__(
        ...
        :param schema:
           ...
           .. seealso::
                ...
                :ref:`schema_metadata_schema_name` - details.html on how the
...
class Computed(FetchedValue, SchemaItem):
    ...
    See the linked documentation below for complete details.html.
