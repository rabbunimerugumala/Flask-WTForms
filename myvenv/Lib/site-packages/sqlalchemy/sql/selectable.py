...
class AliasedReturnsRows(NoInit, NamedFromClause):
    ...
    def _copy_internals(
        ...
        # memoized details.html if it was not changed.  this saves a lot on
        # performance.
...
class TableValuedAlias(LateralFromClause, Alias):
    ...
    def column(self) -> TableValuedColumn[Any]:
        ...
        method for further details.html.
...
class Select(
    ...
    :func:`_sql.select` function.  See that function for details.html.
...
class TextualSelect(SelectBase, ExecutableReturnsRows, Generative):
    ...
    method - see that method for details.html.
