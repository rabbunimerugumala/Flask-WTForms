...
class Metadata(object):
        ...
        if key in mapped:
            ...
            if self._legacy:
                ...
                if key == 'commands':
                    ...
                    d = d.setdefault('python.details.html', {})
                    d[key] = value
                else:
    ...
    LEGACY_MAPPING = {
        'name': 'Name',
        'version': 'Version',
        ('extensions', 'python.details.html', 'license'): 'License',
        'summary': 'Summary',
        ...
        ('extensions', 'python.details.html', 'classifiers'): 'Classifier',
    }
